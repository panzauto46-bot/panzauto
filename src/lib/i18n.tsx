...
export const translations = {
  en: {
    ...
    "cart.successTitle": "Payment Successful",
    "cart.successDesc": "Your order has been received. Our team will contact you shortly.",
  ...
  id: {
    ...
    "cart.successTitle": "Pembayaran Berhasil",
    "cart.successDesc": "Pesanan kamu sudah masuk. Tim kami akan segera menghubungi kamu.",
